...
public class CellRangeTest {
    ...
    public void
    testCellRangeRangeWithNegativeRowStartThrowsIllegalArgumentException()
    {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void
    testCellRangeRangeWithNegativeRowEndThrowsIllegalArgumentException()
    {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void
    testCellRangeRangeWithNegativeColStartThrowsIllegalArgumentException()
    {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void
    testCellRangeRangeWithNegativeColEndThrowsIllegalArgumentException()
    {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void
    testCellRangeRangeWithAllNegativeParamsThrowsIllegalArgumentException()
    {
    ...
    @Test
    public void
    testCellRangeRangeNumCellsNonZeroStartingRangeReturnsActualNumberOfCellsInRange()
    {
    ...
    @Test
    public void
    testCellRangeRangeNumCellsJaggedReturnsActualNumberOfCellsInRange()
    {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void
    testCellRangeRangeStartGreaterThanEndThrowsIllegalArgumentException()
    {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void
    testCellRangeRangeRowStartGreaterThanRowEndThrowsIllegalArgumentException()
    {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void
    testCellRangeRangeColStartGreaterThanColEndThrowsIllegalArgumentException()
    {
        CellRange range = CellRange.range(2, 0, 2, 0);
